package com.squidward.latihansharedpreference.utils;

/* Tanggal Pengerjaan : 30 April - 1 Mei 2020
    Deksripsi         : Buat Preference
    Nama              : Nofrizal
    NIM               : 10117139
    Kelas             : IF-4
 */
...
public class Preference {
    ...
    private static final String PREF_SESSION = "com.squidward.latihansharedpreference.session";
